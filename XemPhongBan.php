...
<body class="bg-gray-100 p-8">
    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-lg">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Danh Sách Phòng Ban</h1>
        <p class="text-lg text-gray-600 mb-6">Dưới đây là danh sách tất cả các phòng ban hiện có.</p>
                        ...
                        ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    <a href="XemNhanVien.php?idpb=<?= urlencode($idpb) ?>" class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-xs px-4 py-2 transition-colors">
                                        Xem Nhân Viên
                                    </a>
                                </td>
                            </tr>
